...
public class TaskTableSorter extends TaskTableModel{
	...
	Comparator comparator = new Comparator(){
		public int compare(Object o1, Object o2){
			...
			switch(sorting_column){
				...
				case 5: return task1.getStatus( CurrentDate.getDate() ) - task2.getStatus( CurrentDate.getDate() );
	...
	public Object getChild(Object parent, int index) {
		...
		if (parent instanceof IProject){
			if( activeOnly() ) c = CurrentProject.getTaskList().getActiveSubTasks(null, CurrentDate.getDate());
			else c = CurrentProject.getTaskList().getTopLevelTasks();
		}
		else{
			ITask t = (ITask) parent;
			if(activeOnly()) c = CurrentProject.getTaskList().getActiveSubTasks(t.getID(), CurrentDate.getDate());
